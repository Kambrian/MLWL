...
%   $Revision: 1.1.6.11 $  $Date: 2009/11/09 16:27:09 $ (Matlab2010b)
%   % Rev: J.X. Han 12/02/2011, add 'K' (long int) support for bintable
...
switch type
    ...
    case {'int32' 'single' 'bit32'}
        sz = 4;
    case {'int64' 'double' 'bit64'} % Rev: J.X. Han 12/02/2011, add 'K' (long int) support for bintable
        sz = 8;
    otherwise
