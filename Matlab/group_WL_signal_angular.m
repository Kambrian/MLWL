function [rs,er2,m,n,s,w,em2,es2]=group_WL_signal_angular(cen,rrange,zcen,sky,nbin,flag_comoving)
% lensing output for each group, in angular scale bins, not physical or comoving bins
