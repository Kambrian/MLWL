...
grpmock=loadGAMAcsv('201309/DMUG3Cv06/mocks/G3CMockFoFGroupv06.csv',6);
% halomock=loadGAMAcsv('201309/DMUG3Cv06/mocks/G3CMockHaloGroupv06.csv',6);
% halomock.Mult=halomock.Nhalo;halomock=rmfield(halomock,'Nhalo');
% halomock.Zfof=halomock.Zhalo;halomock=rmfield(halomock,'Zhalo');
galmock=loadGAMAcsv('201309/DMUG3Cv06/mocks/G3CMockGalv06.csv',6);
%%
