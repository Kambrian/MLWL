T=53.1;   %data window <---> leakage in frequency space (determines spetrum convolution kernal width)
...
T=16;   %data window <---> leakage in frequency space (determines spetrum convolution kernal width)
            % also sets spectra physical resolution, if this is the data
            % period: w0=2*pi/T;
