function [cf,gof,out]=createFit(r1,s1,w,z,M)
...
% ex_ = ex_ | (s1 <= 0);
% ex_ = ex_ | (s1 <= 0)|(r1>70);
% fo_ = fitoptions('method','NonlinearLeastSquares','Lower',[100   0 1],'Upper',[100000     10 100]);
fo_ = fitoptions('method','NonlinearLeastSquares','Lower',[0 1],'Upper',[10 100]);
...
% ft_ = fittype('lensing_rfunc(x,M,b,z,c)',...
%     'dependent',{'y'},'independent',{'x'},'problem','z',...
%     'coefficients',{'M', 'b','c'});

ft_ = fittype('lensing_rfunc(x,M,b,z,c)',...
    'dependent',{'y'},'independent',{'x'},'problem',{'M','z'},...
    'coefficients',{'b','c'});
...
%     [cf,gof,out] = fit(r1(ok_),s1(ok_),ft_,fo_,'problem',z);
    [cf,gof,out] = fit(r1(ok_),s1(ok_),ft_,fo_,'problem',{M,z});
end
